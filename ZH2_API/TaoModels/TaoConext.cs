...
public partial class TaoConext : DbContext
{
    public TaoConext()
    {
    }

    public TaoConext(DbContextOptions<TaoConext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\ryalkk\\source\\repos\\ZH2_RYALKK\\ZH2_RYALKK\\TaoDatabase.mdf;Integrated Security=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Course>(entity =>
        {
            entity.HasKey(e => e.CourseSk).HasName("PK__Course__C92D8C4803EEDBC3");
        ...
        {
            entity.HasKey(e => e.DayId).HasName("PK__Day__BF3DD825D9D1AED2");
        ...
        {
            entity.HasKey(e => e.EmployementId).HasName("PK__Employem__BFBFF076221FFE41");
        ...
        {
            entity.HasKey(e => e.InstructorSk).HasName("PK__Instruct__9D017A28FDC8D693");
        ...
        {
            entity.HasKey(e => e.LessonSk).HasName("PK__Lesson__B08512E2D9383950");
        ...
        {
            entity.HasKey(e => e.RoomSk).HasName("PK__Room__328616CF6CCD6766");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__Status__C8EE204314CDCF01");
        ...
        {
            entity.HasKey(e => e.TimeId).HasName("PK__Time__E04ED967D920BFBF");
